...
Step 1: click on the donate now button to go to the University of Saskatchewan Website. You should see a screen pop up that looks like the image below 

​

Step 2: Enter your gift amount and comments and then continue on through the prompts. 


<button name="button" onclick="https://donate.usask.ca/online/artsandscience.php?fund_code=GEOLDEPT">DONATE -></button>
