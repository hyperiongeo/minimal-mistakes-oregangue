...
<button onclick="window.location.href='{{ '/golf/2026_calgary_registration.html' | relative_url }}';">
Registration
</button>


<button onclick="window.location.href='{{ '/golf/2026_calgary_sponsors.html' | relative_url }}';">
